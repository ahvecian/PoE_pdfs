# Principios de Economía · material del curso (copia de trabajo)
...
- `slides/`: `W#_esp.pdf` y `W#_eng.pdf`, semanas 1 a 14.
- `problem_sets/`: `PS#_ESP.pdf` y `PS#_EN.pdf`, sin soluciones (las soluciones no se guardan en este repositorio; ver `problem_sets/latex/PS#/pdf/*_sol.pdf` en `PoE_source`).
